    ...
    try {
        ...
        foreach ($detail_batch_map as $id_detail => $batches) {
            ...
            if ($status_koreksi == 'SELESAI') {
                ...
                $satuan_perdus = intval($barang_data_toko['SATUAN_PERDUS'] ?? 1);
                ...
                foreach ($batches as $batch) {
                    ...
                    if ($selisih_masuk_batch != 0) {
                        ...
                        if ($satuan_toko == 'PIECES') {
                            $selisih_masuk_batch_stock = $selisih_masuk_batch * $satuan_perdus;
                        }
                    ...
                    if ($perubahan_selisih_dus != 0) {
                        // Konversi ke pieces
                        $perubahan_selisih_pieces = $perubahan_selisih_dus * $satuan_perdus;
                        ...
                        $stmt_mutasi_rusak->bind_param("ssssiiidds", $id_mutasi_rusak, $kd_barang, $kd_lokasi_tujuan, $user_id, $perubahan_selisih_dus, $satuan_perdus, $perubahan_selisih_pieces, $harga_barang_pieces, $total_uang, $id_batch_history);
                ...
                // Update STOCK dan STOCK_HISTORY untuk gudang (lokasi asal) berdasarkan selisih kirim
                ...
                if ($result_barang_gudang->num_rows > 0) {
                    ...
                    $satuan_perdus_gudang = intval($barang_data_gudang['SATUAN_PERDUS'] ?? 1);
                    ...
                    foreach ($batches as $batch) {
                        ...
                        if ($selisih_kirim_batch != 0) {
                            ...
                            if ($satuan_gudang == 'PIECES') {
                                $selisih_kirim_batch_stock = $selisih_kirim_batch * $satuan_perdus_gudang;
                            }
