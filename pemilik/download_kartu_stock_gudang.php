...
if ($result_barang->num_rows == 0) {
    header("Location: kartu_stock_gudang.php?kd_lokasi=" . urlencode($kd_lokasi));
    exit();
}
...
<head>
    ...
    <title>Download Kartu Stock Gudang - <?php echo htmlspecialchars($barang['NAMA_BARANG']); ?></title>
    <style>
        @media print {
...
<body>
    ...
    <div class="print-container">
        ...
        <div class="info-section">
            <div class="row">
                <label>Kode Barang:</label> <?php echo htmlspecialchars($barang['KD_BARANG']); ?>
            </div>
            <div class="row">
                <label>Nama Barang:</label> <?php echo htmlspecialchars($barang['NAMA_BARANG']); ?>
            </div>
            <div class="row">
                <label>Merek:</label> <?php echo htmlspecialchars($barang['NAMA_MEREK']); ?>
            </div>
            <div class="row">
                <label>Kategori:</label> <?php echo htmlspecialchars($barang['NAMA_KATEGORI']); ?>
            </div>
            <div class="row">
                <label>Periode:</label> <?php echo formatTanggal($tanggal_dari); ?> s/d <?php echo formatTanggal($tanggal_sampai); ?>
            </div>
            <div class="row">
                <label>Stock Saat Ini:</label> <strong><?php echo number_format($barang['STOCK_SEKARANG'], 0, ',', '.'); ?> <?php echo htmlspecialchars($barang['SATUAN']); ?></strong>
            </div>
        </div>
