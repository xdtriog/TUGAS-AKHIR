            ...
            <div class="card-body">
                ...
                <form method="GET" action="" class="row g-3">
                    ...
                    <div class="col-md-4 d-flex align-items-end gap-2">
                        ...
                        <a href="download_laporan_stock_opname_gudang.php?kd_lokasi=<?php echo urlencode($kd_lokasi); ?>&tanggal_dari=<?php echo urlencode($tanggal_dari); ?>&tanggal_sampai=<?php echo urlencode($tanggal_sampai); ?>" 
            ...
            <div class="table-responsive">
                <table id="tableLaporanStockOpname" class="table table-custom table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="17" class="text-center text-muted">Tidak ada data stock opname pada periode yang dipilih</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
