...
if ($result_lokasi->num_rows == 0 || $result_lokasi->fetch_assoc()['TYPE_LOKASI'] != 'toko') {
    header("Location: laporan.php");
    exit();
}
...
<head>
    ...
    <title>Laporan Mutasi Barang Rusak - <?php echo htmlspecialchars($lokasi['NAMA_LOKASI']); ?></title>
    <style>
        @media print {
            body {
                margin: 0;
    ...
    <div class="print-container">
        ...
        <div class="summary-section">
            <div class="summary-card">
                <div class="value"><?php echo number_format($summary['TOTAL_MUTASI'], 0, ',', '.'); ?></div>
                <div class="label">Total Mutasi</div>
            </div>
            <div class="summary-card">
            ...
            <div class="summary-card">
                <div class="value"><?php echo number_format($summary['TOTAL_MUTASI_PIECES'], 0, ',', '.'); ?></div>
                <div class="label">Total Mutasi (Pieces)</div>
            </div>
            <div class="summary-card">
        ...
        <table>
            ...
            <tbody>
                <?php if ($result_mutasi && $result_mutasi->num_rows > 0): ?>
                    <?php 
                    $no = 1;
                    while ($row = $result_mutasi->fetch_assoc()): 
                    ?>
                        <tr>
