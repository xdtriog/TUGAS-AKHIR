                ...
                <div class="table-responsive">
                    <table id="tableIntervalPOQ" class="table table-custom table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="9" class="text-center text-muted">Tidak ada data interval POQ</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                ...
                <div class="table-responsive">
                    <table id="tableKuantitasPOQ" class="table table-custom table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="12" class="text-center text-muted">Tidak ada data perhitungan kuantitas POQ</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#tableKuantitasPOQ').DataTable({
                ...
                pageLength: 25,
                lengthMenu: [[10, 25, 50, 100, -1], [10, 25, 50, 100, "Semua"]],
                order: [[10, 'desc']], // Sort by Waktu Perhitungan descending
                columnDefs: [
