        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3">
                <div class="stat-card warning">
                    <div class="stat-value"><?php echo number_format($summary['TOTAL_MUTASI_PIECES'], 0, ',', '.'); ?></div>
            ...
            <div class="table-responsive">
                <table id="tableLaporanMutasiBarangRusak" class="table table-custom table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="10" class="text-center text-muted">Tidak ada data mutasi barang rusak pada periode yang dipilih</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
