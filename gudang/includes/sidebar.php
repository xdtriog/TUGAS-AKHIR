<?php
// Sidebar Component untuk Gudang
...
<div class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li><a href="perpindahan_barang.php" class="<?php echo $active_page == 'perpindahan_barang' ? 'active' : ''; ?>" data-icon="🔄"><span>Perpindahan Barang</span></a></li>
