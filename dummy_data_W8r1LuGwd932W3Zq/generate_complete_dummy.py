...
HARGA_PESAN_DUS = 300000  # Harga beli per dus (30000 * 10)
BIAYA_PENGIRIMAN = 50000  # Biaya pengiriman
HARGA_JUAL_PIECE = 33000  # Harga jual per piece
MIN_STOCK_TOKO = 10  # Minimal stock toko dalam PIECES (trigger untuk resupply)
MAX_STOCK_TOKO = 50  # Maksimal stock toko dalam PIECES (target setelah resupply)
MIN_STOCK_GUDANG = 10  # Minimal stock gudang dalam DUS (trigger untuk pemesanan)
MAX_STOCK_GUDANG = 30  # Maksimal stock gudang dalam DUS (target setelah pemesanan)
...
def pesan_barang_baru(tanggal, jumlah_pesan=None):
    ...
    # Harga pesan: bisa bervariasi sedikit (290000-310000 per dus)
    harga_pesan_dus = random.randint(290000, 310000)
...
while current_date <= END_DATE:
    ...
    if stock_toko > 0:
        ...
        for _ in range(num_transactions):
            ...
            # Pastikan jumlah_jual minimal 1 dan maksimal stock_toko
            max_jual = min(30, stock_toko)
            if max_jual < 1:
                break
